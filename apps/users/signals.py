...
def create_user_related_profiles(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        with transaction.atomic():
            ...
            # Generate an OTP — the email is sent by FirstTimeSetupView when the
            # user actually arrives on the page, not here at account-creation time.
            # Sending it here would email a code the user isn't ready to use yet.
