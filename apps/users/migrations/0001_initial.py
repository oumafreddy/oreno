    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(default='staff', help_text='Defines the role assigned to the user.', max_length=128, verbose_name='User Role')),
                ('registration_date', models.DateTimeField(default=apps.users.models.default_datetime, help_text='The date and time when the user registered.', verbose_name='Registration Date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('admin', 'Admin'), ('manager', 'Manager'), ('staff', 'Staff')], db_index=True, default='staff', help_text='Role of the user within the organization.', max_length=50, verbose_name='Role')),
                ('organization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='roles', to='organizations.organization', verbose_name='Organization')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('otp', models.CharField(help_text='The OTP code for verification.', max_length=6, verbose_name='One-Time Password')),
                ('is_verified', models.BooleanField(default=False, help_text='Indicates whether this OTP has been verified.', verbose_name='Verification Status')),
                ('role', models.CharField(choices=[('admin', 'Admin'), ('manager', 'Manager'), ('staff', 'Staff')], default='staff', help_text='Role context for the OTP usage.', max_length=50, verbose_name='Role')),
